...
// //* use Split With Content for SignUp page
...
//           <a
//             class="inline-flex items-center justify-center w-16 h-16 text-blue-600 bg-white rounded-full sm:w-20 sm:h-20 dark:bg-gray-900"
//             href="/"
//           >
//             <span class="sr-only">Home</span>
//             <svg
...
//               id="FirstName"
//               name="first_name"
//               class="w-full mt-1 text-sm text-gray-700 bg-white border-gray-200 rounded-md shadow-sm dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200"
//             />
//           </div>
...
//                 class="w-5 h-5 bg-white border-gray-200 rounded-md shadow-sm dark:bg-gray-800 dark:border-gray-700"
//               />
...
//             <button
//               class="inline-block px-12 py-3 text-sm font-medium text-white bg-blue-600 border border-blue-600 transition rounded-md shrink-0 hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500 dark:hover:bg-blue-700 dark:hover:text-white"
//             >
//               Create an account
//             </button>
