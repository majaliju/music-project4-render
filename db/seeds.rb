...
#~ John Legend
c2 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), location: "Red Rocks Amphitheatre", image: "/venues-images/red-rocks.jpg", artist_id: a2.id})
...
#~ Lil Uzi Vert
c3 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), location: "Radio City Music Hall", image: "/venues-images/radio-city-music-hall.jpg", artist_id: a3.id})
...
# #~ Alicia Keys
# c4 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), location: "Tabernacle", image: "/venues-images/tabernacle.jpg", artist_id: a4.id})
...
# #~ Brent Faiyaz
# c5 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), location: "Gorge Amphitheatre", image: "/venues-images/gorge-amphitheatre.jpg", artist_id: a5.id})
...
# #~ Freddie Gibbs
# c6 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), location: "Grand Ole Opry", image: "/venues-images/grand-ole-opry.jpg", artist_id: a6.id})
...
# #~ Ed Sheeran
# c7 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a7.id, location: "Ryman Auditorium", image: "/venues-images/ryman.jpg"})
...
# #~ Chris Stapleton
# c8 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a8.id, location: "Madison Square Garden", image: "/venues-images/msg.jpg"})
# p8 = Post.create({comment_body: "best offer only! email me", for_sale: true, tickets: 2, user_id: u2.id, concert_id: c8.id})

# #~ Lil Wayne
# c9 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a9.id, location: "The Greek Theatre", image: "/venues-images/the-greek.png"})

# #~Bad Bunny
# c10 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a10.id, location: "Merriweather Post Pavilion", image: "/venues-images/merriweather.jpg"})
...
# #~ Weeknd
# c11 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a11.id, location: "The Fillmore", image: "/venues-images/the-fillmore-san-francisco.jpg"})
...
# #~ Doja Cat
# c12 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a12.id, location: "Bowery Ballroom", image: "/venues-images/bowery-ballroom.jpg"})
...
# #~ Dua Lipa
# c13 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a13.id, location: "Metro Chicago", image: "/venues-images/metro-chicago.jpg"})
...
# #~ Billie Eilish
# c14 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a14.id, location: "Stubbs", image: "/venues-images/stubbs.jpg"})
...
# #~ Lil Durk
# c15 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a15.id, location: "Great Scott", image: "/venues-images/great-scott.jpg"})
# p15 = Post.create({comment_body: "neeeeeed 2 tix, please lmk", for_sale: false, tickets: 2, user_id: u2.id, concert_id: c15.id})

# #~ Giveon
# c16 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a16.id, location: "Royal Albert Hall", image: "/venues-images/albert-hall.jpg"})
# p16 = Post.create({comment_body: "looking for a ticket", for_sale: false, tickets: 1, user_id: u3.id, concert_id: c16.id})


# #~ SZA
# c17 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a17.id, location: "Sydney Opera House", image: "/venues-images/sydney-opera-hall.jpg"})
# p17 = Post.create({comment_body: "selling 2 tickets!! hmu for price", for_sale: true, tickets: 2, user_id: u4.id, concert_id: c17.id})

# #~ Tyler the Creator
# c18 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a18.id, location: "The O2 Arena", image: "/venues-images/02-arena.jpg"})
...
# #~ Morgan Wallen
# c19 = Concert.create({date: Faker::Date.between(from: '2023-01-01', to: '2024-05-25'), artist_id: a19.id, location: "Eventim Apollo", image: "/venues-images/eventim-apollo.jpg"})
